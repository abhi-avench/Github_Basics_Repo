...
| ---- | ------------ | --------- | ----------------------------------------- | ------------------------ | ----------------------------------------------- |
| 1.   | R2           | WD:59     | `_winch_type_no_gear_stat_std_L_00`       | `1C2#0000XX0000000000`   | See Table 1: Gear Status Control                |
| 2.   | R1           | WD:60     | `_winch_type_no_gear_stat_std_R_00`       | `1C1#0000XX0000000000`   | See Table 1: Gear Status Control (R1 variant)   |
| 3.   | R2           | WD:61     | `_3_45_load_unit_graphic_L_std_00`        | `1C2#000000000000XXXXXX` | See Tables 2-5: Force Calculations              |
| 4.   | R1           | WD:62     | `_3_45_load_unit_graphic_R_std_00`        | `1C1#0000000000XXXXXX`   | See Tables 2-5: Force Calculations (R1 variant) |
| 5.   | R1           | WD:63     | `_3_45_rope_length_unit_graphic_R_std_00` | `1C1#0000XXXXXX000000`   |                                                 |
| 6.   | R2           | WD:64     | `_3_45_rope_length_unit_graphic_L_std_00` | -                        | Left rope length display                        |

### Reference Tables

**Table 1: Gear Status Control**
...
**Table 2: kN Force Calculations (Bit60=1)**
| CAN Payload | Actual % | Max Force | Result (kN) |
|-------------|----------|-----------|-------------|
| `1C2#0000000000FFFF13` | 127.5 | 1023 | 1304 |
| `1C2#0000000000FF0110` | 127.5 | 1 | 1 |
| `1C2#000000000001FF13` | 0.5 | 1023 | 5 |

**Table 3: Tonne Force Calculations (Bit60=0)**
| CAN Payload | Actual % | Max Force | Result (Tonne) |
|-------------|----------|-----------|----------------|
| `1C2#0000000000FFFF03` | 127.5 | 1023 | 132.9 |
| `1C2#0000000000FF0100` | 127.5 | 1 | 0.13 |

**Table 4: Load Bar Percentage**
| Payload | Byte 6 | Load % |
|---------|--------|--------|
| `1C2#0000000000000000` | 0x00 | 0.0% |
| `1C2#00000000007F0000` | 0x7F | 63.5% |
| `1C2#0000000000FF0000` | 0xFF | 100% |

**Table 5: Edge Cases**
| Payload | Byte 6 | Load % |
|---------|--------|--------|
| `1C2#0000000000C80000` | 0xC8 | 100% |
| `1C2#0000000000C60000` | 0xC6 | 99.0% |
