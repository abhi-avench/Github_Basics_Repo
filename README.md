...
| 5.   | R1           | WD:63     | `_3_45_rope_length_unit_graphic_R_std_00` | `1C1#0000XXXXXX000000` | See Table 5: for load bar% and Rope length value of R1 |
| 6.   | R2           | WD:64     | `_3_45_rope_length_unit_graphic_L_std_00` | `1C2#0000XXXXXX000000` | See Table 5: for load bar% and Rope length value of R2 |
...
| :--------------------- | :------- | :-------- | :------------------- | :------------- |
| `1C2#0000000000FFFF03` | 127.5    | 1023      | 1304.325×0.101971621 | 133.0          |
| `1C2#0000000000FF0100` | 127.5    | 1         | 1.275×0.101971621    | 0.1            |
| `1C2#000000000001FF03` | 0.5      | 1023      | 5.115×0.101971621    | 0.5            |
| `1C2#0000000000FEFE03` | 127      | 1022      | 1297.94×0.101971621  | 132.3          |
| `1C2#0000000000FF0001` | 127.5    | 256       | 326.4×0.101971621    | 33.2           |
...
| CAN payload            | Actual % | Max Force | Calculation          | Result (Tonne) |
| :--------------------- | :------- | :-------- | :------------------- | :------------- |
| `1C1#0000000000FFFF03` | 127.5    | 1023      | 1304.325×0.101971621 | 133.0          |
| `1C1#0000000000FF0100` | 127.5    | 1         | 1.275×0.101971621    | 0.1            |
| `1C1#0000000000FFFF03` | 0.5      | 1023      | 5.115×0.101971621    | 0.5            |
| `1C1#0000000000FEFE03` | 127      | 1022      | 1297.94×0.101971621  | 132.3          |
| `1C1#0000000000FF0001` | 127.5    | 256       | 326.4×0.101971621    | 33.2           |
...
| ---------------------- | ------------------------------- | --------------------------- | ----------------------------- | ------------------------- | ----------------------------------------- | ---------- | ------------------------------- |
| `1C1#000064800C000000` | 100                             | `0x064`                     | 200                           | `0x0C8`                   | (100 / 200) × 100                         | 50%        | 100 × 0.1 = 10 m                |
| `1C1#00003240F1000000` | 50                              | `0x032`                     | 500                           | `0x1F4`                   | (50 / 500) × 100                          | 10%        | 50 × 0.1 = 5 m                  |
| `1C1#0000FAA00F000000` | 250                             | `0x0FA`                     | 250                           | `0x0FA`                   | (250 / 250) × 100                         | 100%       | 250 × 0.1 = 25 m                |
| `1C1#00007D803E000000` | 125                             | `0x07D`                     | 1000                          | `0x3E8`                   | (125 / 1000) × 100                        | 12.5%      | 125 × 0.1 = 12.5 m              |
| `1C1#0000011000000000` | 1                               | `0x001`                     | 1                             | `0x001`                   | (1 / 1) × 100                             | 100%       | 1 × 0.1 = 0.1 m                 |
| `1C1#0000FFFFFF000000` | 4095                            | `0xFFF`                     | 4095                          | `0xFFF`                   | (4095 / 4095) × 100                       | 100%       | 4095 × 0.1 = 409.5 m            |
| `1C1#000010F0FF000000` | 1                               | `0x001`                     | 4095                          | `0xFFF`                   | (1 / 4095) × 100                          | 0.024%     | 1 × 0.1 = 0.1 m                 |
...
| PAYLOADS               | Remaining Rope length (Decimal) | Remaining Rope length (Hex) | Maximum Rope length (Decimal) | Maximum Rope length (Hex) | Calculation = (Remaining / Maximum) × 100 | Load Bar % | Load Unit (m) = Remaining × 0.1 |
| ---------------------- | ------------------------------- | --------------------------- | ----------------------------- | ------------------------- | ----------------------------------------- | ---------- | ------------------------------- |
| `1C2#000064800C000000` | 100                             | `0x064`                     | 200                           | `0x0C8`                   | (100 / 200) × 100                         | 50%        | 100 × 0.1 = 10 m                |
| `1C2#00003240F1000000` | 50                              | `0x032`                     | 500                           | `0x1F4`                   | (50 / 500) × 100                          | 10%        | 50 × 0.1 = 5 m                  |
| `1C2#0000FAA00F000000` | 250                             | `0x0FA`                     | 250                           | `0x0FA`                   | (250 / 250) × 100                         | 100%       | 250 × 0.1 = 25 m                |
| `1C2#00007D803E000000` | 125                             | `0x07D`                     | 1000                          | `0x3E8`                   | (125 / 1000) × 100                        | 12.5%      | 125 × 0.1 = 12.5 m              |
| `1C2#0000011000000000` | 1                               | `0x001`                     | 1                             | `0x001`                   | (1 / 1) × 100                             | 100%       | 1 × 0.1 = 0.1 m                 |
| `1C2#0000FFFFFF000000` | 4095                            | `0xFFF`                     | 4095                          | `0xFFF`                   | (4095 / 4095) × 100                       | 100%       | 4095 × 0.1 = 409.5 m            |
| `1C2#000010F0FF000000` | 1                               | `0x001`                     | 4095                          | `0xFFF`                   | (1 / 4095) × 100                          | 0.024%     | 1 × 0.1 = 0.1 m                 |
